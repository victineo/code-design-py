...
class Calculator3:
    ...
    def calculate(self, request: FlaskRequest) -> Dict: # type: ignore
        ...
        multiplication = self.__caltulate_multiplication(input_data)
    ...
    def __caltulate_multiplication(self, numbers: List[float]) -> float:
        multiplication = 1
        for n in numbers: multiplication *= n
